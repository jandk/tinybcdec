...
class BC6HDecoderTest {
    ...
    void testBC6H_UF16() throws IOException {
        ...
        BlockDecoder decoder = BlockDecoder.create(BlockFormat.BC6H_UF16);
    ...
    void testBC6H_SF16() throws IOException {
        ...
        BlockDecoder decoder = BlockDecoder.create(BlockFormat.BC6H_SF16);
        byte[] actual = decoder.decode(256, 256, src, BCTestUtils.DDS_HEADER_SIZE);
    ...
    void testBC6H_UF32() throws IOException {
        ...
        BlockDecoder decoder = BlockDecoder.create(BlockFormat.BC6H_UF32);
        byte[] actual = decoder.decode(256, 256, src, BCTestUtils.DDS_HEADER_SIZE);
    ...
    void testBC6H_SF32() throws IOException {
        ...
        BlockDecoder decoder = BlockDecoder.create(BlockFormat.BC6H_SF32);
        byte[] actual = decoder.decode(256, 256, src, BCTestUtils.DDS_HEADER_SIZE);
