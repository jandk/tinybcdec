...
final class BC5UFloat extends BlockDecoder {
    ...
    void decodeBlock(ByteBuffer src, int srcPos, ByteBuffer dst, int dstPos, int stride) {
        ...
        long rIndices = BC4UFloat.buildAlphas(ByteIO.getLong(src, srcPos/**/), rAlphas);
        long gIndices = BC4UFloat.buildAlphas(ByteIO.getLong(src, srcPos + 8), gAlphas);
